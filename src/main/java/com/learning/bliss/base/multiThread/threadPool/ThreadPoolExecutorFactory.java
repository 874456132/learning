package com.learning.bliss.base.multiThread.threadPool;
...
public class ThreadPoolExecutorFactory {
     ...
     * 核心线程1,无界队列
     */
    public static ExecutorService threadPoolExecutor4 = (ExecutorService) Executors.newSingleThreadExecutor();
